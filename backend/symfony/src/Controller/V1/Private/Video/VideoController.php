...
class VideoController extends BasePrivateController
{
    ...
    #[OA\Get(
        description: "Retrieve a signed HLS manifest from CDN. Works as a proxy to the CDN. Manifest is a dynamically generated and includes a signed links. If a quality is specified, the manifest will be generated for that quality and will includes signed links to a video segments. Otherwise, the manifest will be generated and will include signed links to this proxy for every available quality.",
        summary: "Retrieve a signed HLS manifest from CDN",
        tags: [self::TAG],
    )]
